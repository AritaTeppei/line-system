              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      type="email"
                      className={`flex-1 rounded-xl border bg-gray-50 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 ${emailVerified ? 'border-green-400 bg-green-50' : 'border-gray-200'}`}
                      value={email}
                      onChange={(e) => {
